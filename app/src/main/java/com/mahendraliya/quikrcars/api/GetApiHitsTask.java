 ...
 */
public class GetApiHitsTask extends AsyncTask<Void, Void, Void> {
    ...
    public GetApiHitsTask(Context context, ITaskResponse callback) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        mProgress = ProgressDialog.show(mContext, "", mContext.getString(R.string.dialog_getting_api_hits));
    }

    @Override
    protected Void doInBackground(Void... params) {
        try {
            URL obj = new URL(Constants.URL_API_HITS);
